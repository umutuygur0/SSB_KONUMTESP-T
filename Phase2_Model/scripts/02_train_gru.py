"""
Phase 2 — Adım 2: GRU Model Eğitimi
Input : (batch, 40, 12)
Output: (batch, 3)  [ΔNorth, ΔEast, ΔUp] metre
"""
...
def plot_training(history: dict, best_epoch: int, model_name: str = "GRU"):
...
def train():
    print("=" * 60)
    print("ADIM 2: GRU Model Eğitimi")
    ...
    print(f"  GRU parametreleri: {n_params:,}\n")
    ...
    for epoch in range(1, MAX_EPOCHS + 1):
        ...
        if vl < best_val:
            ...
            torch.save(model.state_dict(), PHASE2_OUT / "best_gru.pt")
        else:
            no_improve += 1
    ...
    with open(PHASE2_OUT / "gru_training_meta.json", "w", encoding="utf-8") as f:
        json.dump(meta, f, indent=2)

    plot_training(history, best_ep, model_name="GRU")
